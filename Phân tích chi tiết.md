...
![UC Tong Quat](Images/UC_tongquat.png)

 5.2. Use Case: Tạo công việc mới
...
![UC Tao cong viec](Images/UC_taocongviec.png)

 5.3. Use Case: Phân công công việc
...
![UC Phan cong cong viec](Images/UC_phancongcongviec.png)

 5.4. Use Case: Cập nhật trạng thái công việc
...
![UC Cap nhat trang thai cong viec](Images/UC_capnhattrangthai.png)

 5.5. Use Case: Theo dõi tiến độ công việc
...
![UC Theo doi tien do cong viec](Images/UC_theodoitiendocongviec.png)

 6. Phân tích Activity Diagram

 6.1. Activity Diagram — Đăng nhập
...
![Activity Dang Nhap](Images/Activity_dangnhap.png)

6.2. Activity Diagram — Phân công công việc
...
![Activity Phan Cong](Images/Activity_phancongcongviec.png)

6.3. Activity Diagram — Cập nhật trạng thái công việc
...
![Activity Cap Nhat](Images/Activity_capnhattrangthai.png)

7. Phân tích Sequence Diagram
...
Biểu đồ mô tả quá trình xác thực tài khoản của nhân viên trên hệ thống.
   ...
   ![Sequence Dang Nhap](Images/Sequence_dangnhap.png)

7.2. Sequence Diagram — Tạo công việc
...
![Sequence Tao Cong Viec](Images/Sequence_taocongviec.png)

7.3. Sequence Diagram — Cập nhật trạng thái công việc
...
![Sequence Cap Nhat](Images/Sequence_capnhattrangthai.png)

8. Phân tích Class Diagram
...
9. Thiết kế cơ sở dữ liệu sơ bộ
...
10. Kết luận
 ...
 Hệ thống quản lý công việc nội bộ cho công ty Unikom giúp hỗ trợ quản lý công việc hiệu quả hơn thông qua việc tạo công việc, phân công nhiệm vụ và theo dõi tiến độ thực hiện.
